...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# product: http://ogp.me/ns/product#">
	...
	<?$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH .'/css/easydropdown.css');?>
						...
						<li class="main-nav__item">
							...
							<div class="main-nav-level-1">
								...
								<ul class="main-nav-level-1__list">
									...
									<li class="main-nav-level-1__item">
										<a href="/catalog/yuvelirnye_izdeliya/cepi/" class="main-nav-level-1__link  main-nav-level-1__link--all-items">Смотреть все часы</a>
									</li>
								</ul>
							</div>
						</li>
			...
			<nav id="sidebar" class="navigation">
				...
				<ul class="nav clearfix">
					...
					<li class="parent multi">
						<a href="/about/" class="multilevel"><img
