	...
	<header>
		...
		<div class="section header-middle">
			<div class="section__inner header-middle__inner">
				...
				<?/*
				<a href="/action/kupon_na_million/" class="header-promo-banner">
					<picture>
						<!--[if IE 9]><video style="display: none;"><![endif]-->
						<source srcset="<?= SITE_TEMPLATE_PATH ?>/images/header-banner__win-a-million--touch.jpg" media="(max-width: 1024px)">
						<source srcset="<?= SITE_TEMPLATE_PATH ?>/images/header-banner__win-a-million--desktop.jpg">
						<!--[if IE 9]></video><![endif]-->
						<img src="<?= SITE_TEMPLATE_PATH ?>/images/header-banner__win-a-million--desktop.jpg" alt="Распродажа BLACKFRIDAY">
					</picture>
				</a>
				*/?>
