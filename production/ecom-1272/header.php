			...
			<div class="section__inner header-bottom__inner">
				<nav class="alt-main-nav">
					<ul class="alt-main-nav__list">
						<li class="alt-main-nav__item  alt-main-nav__item--catalog"  data-inner-list="0"><a href="http://zoloto585.ru/catalog/yuvelirnye_izdeliya/" class="alt-main-nav__link">Каталог</a></li>
						<li class="alt-main-nav__item"  data-inner-list="1" data-inner-background-image="none" data-inner-background-color="inherit" data-outer-background-image="http://zoloto585.ru/upload/iblock/ba0/maheev_2img.jpg" data-outer-background-color="inherit"><a href="#" class="alt-main-nav__link">Обручальные кольца</a></li>
						<li class="alt-main-nav__item"  data-inner-list="2" data-inner-background-image="none" data-inner-background-color="inherit" data-outer-background-image="none" data-outer-background-color="inherit"><a href="#" class="alt-main-nav__link">Кольца</a></li>
						<li class="alt-main-nav__item"  data-inner-list="3" data-inner-background-image="none" data-inner-background-color="inherit" data-outer-background-image="none" data-outer-background-color="inherit"><a href="#" class="alt-main-nav__link">Серьги</a></li>
						<li class="alt-main-nav__item"  data-inner-list="4" data-inner-background-image="none" data-inner-background-color="inherit" data-outer-background-image="none" data-outer-background-color="inherit"><a href="#" class="alt-main-nav__link">Кулоны</a></li>
						<li class="alt-main-nav__item"  data-inner-list="5" data-inner-background-image="none" data-inner-background-color="inherit" data-outer-background-image="none" data-outer-background-color="inherit"><a href="#" class="alt-main-nav__link">Колье и цепи</a></li>
						<li class="alt-main-nav__item"  data-inner-list="6" data-inner-background-image="none" data-inner-background-color="inherit" data-outer-background-image="none" data-outer-background-color="inherit"><a href="#" class="alt-main-nav__link">Часы</a></li>
						<li class="alt-main-nav__item"  data-inner-list="7" data-inner-background-image="none" data-inner-background-color="inherit" data-outer-background-image="none" data-outer-background-color="inherit"><a href="#" class="alt-main-nav__link">Серебро</a></li>
						<li class="alt-main-nav__item"  data-inner-list="8" data-inner-background-image="none" data-inner-background-color="inherit" data-outer-background-image="none" data-outer-background-color="inherit"><a href="#" class="alt-main-nav__link">Бижутерия</a></li>
					</ul>
				</nav>
