...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# product: http://ogp.me/ns/product#">
	...
	<link rel="icon" type="image/png" href="/bitrix/templates/zoloto/favicons/favicon-32x32.png" sizes="32x32">
	<link rel="icon" type="image/png" href="/bitrix/templates/zoloto/favicons/favicon-16x16.png" sizes="16x16">
	<link rel="manifest" href="<?= SITE_TEMPLATE_PATH; ?>/favicons/manifest.json">
	<link rel="mask-icon" href="<?= SITE_TEMPLATE_PATH; ?>/favicons/safari-pinned-tab.svg" color="#ed3030">
	<meta name="msapplication-config" content="<?= SITE_TEMPLATE_PATH; ?>/favicons/browserconfig.xml" />
	<meta name="theme-color" content="#ed3030">

	<?$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH .'/css/z585_all.min.css');?>
	...
	<?$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH .'/css/filter.responsive.css');?>
	...
	<script type="text/javascript" src="<?= SITE_TEMPLATE_PATH ?>/js/main.js?v=7"></script>
	<script type="text/javascript" src="<?= SITE_TEMPLATE_PATH ?>/js/msalnikov.js?v=2"></script>
	...
	<header>
		<div class="section header-top header-top--position_fixed">
			<div class="section__inner header-top__inner">
				...
				<?/*
				<div class="header-top__item  top-compare">
					<a href="/catalog/compare/" class="top-compare__button count" id="top-compare-cnt"></a>
				</div>
				*/?>
		...
		<div class="section header-bottom">
			...
			<div class="section__inner header-bottom__inner">
				<nav class="alt-main-nav" data-main-nav='<?include('main_nav_data.php');?>'>
					<ul class="alt-main-nav__list">
						...
						<li class="alt-main-nav__item"  data-inner-list="1"><a href="/catalog/yuvelirnye_izdeliya/kolca/obruchalnye/" class="alt-main-nav__link">Обручальные кольца</a></li>
						<li class="alt-main-nav__item"  data-inner-list="2"><a href="/catalog/yuvelirnye_izdeliya/kolca/" class="alt-main-nav__link">Кольца</a></li>
						<li class="alt-main-nav__item"  data-inner-list="3"><a href="/catalog/yuvelirnye_izdeliya/sergi/" class="alt-main-nav__link">Серьги</a></li>
						<li class="alt-main-nav__item"  data-inner-list="4"><a href="/catalog/yuvelirnye_izdeliya/podveski/" class="alt-main-nav__link">Кулоны</a></li>
						<li class="alt-main-nav__item"  data-inner-list="5"><a href="/catalog/yuvelirnye_izdeliya/cepi_i_kole/" class="alt-main-nav__link">Колье и цепи</a></li>
						<li class="alt-main-nav__item"  data-inner-list="6"><a href="/catalog/chasy/" class="alt-main-nav__link">Часы</a></li>
						<li class="alt-main-nav__item"  data-inner-list="7"><a href="/catalog/yuvelirnye_izdeliya/serebro-925-proby/" class="alt-main-nav__link">Серебро</a></li>
						<li class="alt-main-nav__item"  data-inner-list="8"><a href="/catalog/bizhuteriya/" class="alt-main-nav__link">Бижутерия</a></li>
					</ul>
				</nav>
